...
def fetch_scb_sweden():
    """Fetch retail trade index from Statistics Sweden (SCB) via PxWeb v2."""
    print("Fetching SCB Sweden retail data...")
    url = "https://api.scb.se/OV0104/v2/doris/en/ssd/HA/HA0101/HA0101A/HA0101AKvTab"
    payload = {
        "query": [
...
def fetch_statfin_finland():
    ...
    payload = {
        "query": [
            ...
            {"code": "Muuttuja", "selection": {"filter": "item", "values": ["lv"]}},
